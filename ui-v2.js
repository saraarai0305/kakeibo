...
(() => {
  ...
  function branch(kind){
    ...
    return `<section class="v2-page v2-branch">${top(titleFor(kind),true)}<div class="v2-branch-intro"><p class="v2-kicker">${icon(kind === "record" ? "edit" : kind === "today" ? "sun" : "chart")}${kind === "record" ? "RECORD" : kind === "today" ? "TODAY" : "REVIEW"}</p></div><div class="v2-list">${data.map(x=>choice(...x)).join("")}</div></section>`;
  }
