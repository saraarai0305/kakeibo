...
(() => {
  ...
  function top(title, settings = page !== "settings"){
    return `<header class="v2-top">${stack.length ? `<button class="v2-back" data-v2-back>${icon("back")}戻る</button>` : `<span></span>`}<h1>${esc2(title)}</h1>${settings ? `<button class="v2-top-action" data-v2-go="settings">${icon("settings")}</button>` : `<span class="v2-top-placeholder"></span>`}</header><div class="v2-issue"><span>ISSUE 08 / 2026</span><span>PERSONAL ARCHIVE</span></div>`;
  }
  ...
  function homeV2(){
    return `<section class="v2-page v2-home"><div class="v2-perf"></div><div class="v2-home-title"><p class="v2-kicker">LIFE NOTE</p><h1>何をしますか？</h1><p class="v2-home-seal"><i></i>AUGUST · PERSONAL EDITION</p></div><div class="v2-list">${choice("record","money","edit","記録する","支出・収入 / こころとからだ","01")}${choice("today","today","sun","今日を整える","一日の流れ / チェックリスト / テーマ","02")}${choice("visualize","analysis","chart","見える化する","お金 / こころとからだ","03")}</div><p class="v2-home-foot">ホームはいつでも左上の戻るから</p></section>`;
  }
